...
def main():
	"""This program will recursively draw out the Sierpinski Triangle."""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	:param upper_left_x: x coordinate of upper left corner of each triangle going to draw
	:param upper_left_y: y coordinate of upper left corner of each triangle going to draw
	:return:
	"""
	pause(10)
	# base case has been drawn
	if order == 0:
		return
	else:
